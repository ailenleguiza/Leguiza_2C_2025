 ...
 * | Date       | Description                             |
 * |:-----------|:----------------------------------------|
 * | 19/09/2025 | Documentación creada para el ejercicio 2 |
 *
...
static void medirdistancia(void *pvParameter)
{
	while (true)
	{
		 ulTaskNotifyTake(pdTRUE, portMAX_DELAY); /**portMAX_DELAY: espera indefinidamente hasta que llega una notificación */
		if(encendido)
			{
